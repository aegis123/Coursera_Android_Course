                    ...
                    public void onReceive(Context context, Intent intent) {
                        ...
                        if (getResultCode() != Activity.RESULT_OK) {
                            ...
                            final PendingIntent pendingIntent = PendingIntent
                                    .getActivity(context, 0, pi, PendingIntent.FLAG_UPDATE_CURRENT);
                            ...
                            // successfully
                            mContentView
                                    .setTextViewText(R.id.text, "Download completed succesfully.");
                            ...
                            NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(
                                    context).setAutoCancel(true).setContent(mContentView)
                                    .setContentText("Download completed succesfully.")
