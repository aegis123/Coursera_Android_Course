...
public class Test3 extends ActivityInstrumentationTestCase2<ActivityOne> {
    ...
    public void testRun() {
       ...
       // Spoon.screenshot(getActivity(), "test3_open");
        solo.clearLog();
        ...
        assertTrue("Log message for onResume()' was not found in the Log",
                solo.waitForLogMessage("onResume", 5));
       // Spoon.screenshot(getActivity(), "test3_open_act2");
        solo.clearLog();
        ...
        assertTrue("Log message for onResume()' was not found in the Log",
                solo.waitForLogMessage("onResume", 5));
        //Spoon.screenshot(getActivity(), "test2_closed_act2");
        solo.clearLog();
        ...
        assertTrue("Log message for onResume()' was not found in the Log",
                solo.waitForLogMessage("onResume", 5));
        //Spoon.screenshot(getActivity(), "test2_open2_act2");
    }
}
